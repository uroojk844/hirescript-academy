...
<template>
  ...
  <section class="max-w-8xl mx-auto px-4 md:px-8 lg:px-16 py-16">
    ...
    <p
      class="text-lg sm:text-xl text-gray-700 dark:text-gray-300 text-center mt-4"
    >
      Explore, practice and grow your skills
    </p>
    <div
  ...
  <section class="max-w-8xl mx-auto px-4 md:px-8 lg:px-16 py-16">
    ...
    <p
      class="text-lg sm:text-xl text-gray-700 dark:text-gray-300 text-center mt-4"
    >
      HireScript courses help you master coding with practical, hands-on lessons
    </p>
    <Loader v-if="loading" />
    <div
      v-else
